...
test('tests the base route and returns "Array" for typeof data logged after promise is fulfilled and filtered', () => {
    return response.then(filteredUsers => {
      expect(typeof filteredUsers).toBe("Array");
    });
  });
